...
// It is a design pattern (way of writing code)/(structuring code)

const Listing = require("../models/listing");

module.exports.index = async (req, res) => {     // actual /listings  (see app.js route mounting section)
    // if(req.user) {
...
module.exports.renderNewForm = (req, res) => {     // actual /listings/new  (also for all rest of the routes)
